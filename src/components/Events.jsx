            ...
            <Grid container direction='row' className='events-cont'>
                ...
                <Grid item lg={6} md={12} className='text-col'>
                    <Grid container direction='row' className='events-btns'>
                        ...
                        <Grid item md={4} xs={12} style={{borderBottom: event===1 ? '3px solid #9e7f66':'none'}}  className='btn' onClick={handleClick2}>
                            <h3>{EventsData[1].title}</h3>
                        </Grid>
                        <Grid item md={4} xs={12} style={{borderBottom: event===2 ? '3px solid #9e7f66' :'none'}}  className='btn' onClick={handleClick3}>
